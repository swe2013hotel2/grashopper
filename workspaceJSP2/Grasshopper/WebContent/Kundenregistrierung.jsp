	...
	<h2>Registrierung</h2>
        <form name="form" action="Kundenregistrierung" method="post">
          <div class="form_settings">
			...
			<p><span >Vorname</span><input type="text" class="validate[required]" name="vorname" value="" required/></p>
			<p><span>Nachname</span><input type="text" class="validate[required]" name="nachname" value="" required/></p>
			...
			<p><span>Ort</span><input type="text" class="validate[required]" name="ort" value="" required /></p>
			<p><span>Land</span><input type="text" class="validate[required]" name="land" value="" required/></p>
			<p><span>Passwort:</span><input type="password" class="validate[required,minsize[6]]" name="passwort" value="" required/></p>
