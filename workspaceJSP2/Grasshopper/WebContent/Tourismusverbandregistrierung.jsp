...
<h2>Registrierung</h2>
        <form id="form" name="form" action="TVBRegistrierung" method="post">
          <div class="form_settings">
			...
			<p><span>Passwort:</span><input type="password" name="passwort" id="passwort" class="validate[required,minsize[6]]" value="" required/></p>
